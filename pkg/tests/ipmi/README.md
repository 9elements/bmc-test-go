...
|---|--------|---------|--------------|------------|
| 0 | IPMISensorVoltageTest         | :white_check_mark: | IPMISDRPrecondition | Checks output of 'ipmitool sdr' for values from the config files testdata section |
| 1 | IPMISensorTemperaturTest      | :white_check_mark: | IPMISDRPrecondition | Checks output of 'ipmitool sdr' for values from the config files testdata section |
| 2 | IPMISensorFansTest            | :white_check_mark: | IPMISDRPrecondition | Checks output of 'ipmitool sdr' for values from the config files testdata section |
